    ...
    <div class="container">
        ...
        <form class="py-5" action="{{ route('comics.update', $comic) }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="type" value="{{ $comic->type }}"  name="type"placeholder="Inserisci il Tipo">
            </div>
            <div class="mb-3">
                <label for="price" class="form-label">Prezzo</label>
                <input type="text" class="form-control" id="price" value="{{ $comic->price }}"  name="price"placeholder="Inserisci il Prezzo">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="sale_date" value="{{ $comic->sale_date }}"  name="sale_date"placeholder="Inserisci la Data di Uscita">
            </div>
            <div class="mb-3">
